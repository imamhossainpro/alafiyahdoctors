...
const SEED_DEPARTMENTS = [
  ...
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডাঃ মোহাম্মদ নূর', quals: 'এমবিবিএস, বিসিএস (স্বাস্থ্য), এম.ডি (ইন্টারনাল মেডিসিন)\nসিসিডি-ডায়াবেটোলজি (বারডেম)', specialty: 'মেডিসিন বিশেষজ্ঞ', workplace: 'চট্টগ্রাম মেডিকেল কলেজ হাসপাতাল।', time: 'সন্ধ্যা ৬টা - রাত ৯টা' }),
      makeDoctor({ name: 'ডা: শারমিন আকতার', quals: 'এমবিবিএস (চট্টগ্রাম মেডিকেল কলেজ), বিসিএস (স্বাস্থ্য) \nএম.ডি (ইন্টারনাল মেডিসিন), বিএমইউ', specialty: 'মেডিসিন বিশেষজ্ঞ', workplace: '', time: 'বিকেল ৩টা - সন্ধ্যা ৬টা' }),
      makeDoctor({ name: 'ডাঃ রায়হান আহম্মদ', quals: 'এমবিবিএস, বিসিএস (স্বাস্থ্য), এফসিপিএস-এফ-পি (নিউরোলজি), পিজিটি (মেডিসিন)', specialty: 'মেডিসিন, নিউরোমেডিসিন, ডায়াবেটিস, চর্মরোগ ও বাত-ব্যাথা রোগে অভিজ্ঞ', workplace: '', time: 'প্রতিদিন রাত ৮টা - রাত ১০টা' }),
      makeDoctor({ name: 'ডাঃ মুসলিমা আক্তার', quals: 'এমবিবিএস, বিসিএস, সিসিডি, এম.আর.সি.পি ১ (ইউ.কে),\nডি.এম.ইউ, এ.এম.আর.ডি.এস (কোর্স)', specialty: 'ডায়াবেটিস, থাইরয়েড, আর্থ্রাইটিস ও \nচর্মরোগের অভিজ্ঞ চিকিৎসক ও সনোলজিস্ট', workplace: '', time: 'সন্ধ্যা ৬টা - রাত ৯টা' }),
      makeDoctor({ name: 'ডাঃ মুহাম্মাদ মোসলেহ উদ্দিন', quals: 'এমবিবিএস. (চমেক), পিজিটি (মেডিসিন), \nএফসিপিএস (শেষ পর্ব) [হৃদরোগ]', specialty: 'মেডিসিন, ডায়াবেটিস, বক্ষব্যধি, পরিপাকতন্ত্র চর্ম ও হৃদরোগ চিকিৎসক', workplace: 'চট্টগ্রাম মেডিকেল কলেজ ও হাসপাতাল', time: 'দুপুর ২টা - বিকেল ৪টা' }),
      makeDoctor({ name: 'ডা. মোঃ আব্দুল্লাহ আল নোমান', quals: 'এমবিবিএস (সিইউ), এফসিপিএস ফাইনাল পার্ট (মেডিসিন), \nএমআরসিপি - ইউকে (পেসেস)', specialty: 'মেডিসিন, ডায়াবেটিস ও চর্মরোগে অভিজ্ঞ', workplace: 'চট্টগ্রাম মেডিকেল কলেজ ও হাসপাতাল', time: 'সন্ধ্যা ৭টা - রাত ৯টা' }),
      makeDoctor({ name: 'ডা: সায়্যিদুল আবরার', quals: 'এমবিবিএস, পিজিটি (মেডিসিন), এফসিপিএস, \nগ্যাস্ট্রোএন্টারোলজি (এফ.পি)', specialty: 'মেডিসিন, পরিপাকতন্ত্র চিকিৎসক', workplace: 'চট্টগ্রাম মেডিকেল কলেজ ও হাসপাতাল', time: 'সন্ধ্যা ৭ঃ৩০টা  - রাত ৯ঃ৩০টা' }),
      makeDoctor({ name: 'ডাঃ মোঃ কামরুল আলম', quals: 'এমবিবিএস (সিএমসি), বিসিএস (স্বাস্থ্য)\nএফ.সি.পি.এস, মেডিসিন (শেষ পর্ব)', specialty: 'মেডিসিন চিকিৎসক', workplace: 'ইনডোর মেডিকেল অফিসার, চট্টগ্রাম মেডিকেল কলেজ হাসপাতাল', time: 'সন্ধ্যা ৭টা - রাত ৯টা' }),
      makeDoctor({ name: 'ডাঃ মোহাম্মদ আমিনুল ইসলাম', quals: 'এমবিবিএস (সিওমেক), বিসিএস (স্বাস্থ্য)\nএমডি (এন্ডোক্রাইনোলজি এন্ড মেটাবলিজম)', specialty: 'ডায়াবেটিস, থাইরয়েড ও হরমোন রোগ বিশেষজ্ঞ', workplace: 'কনসালট্যান্ট, ন্যাশনাল একাডেমি ফর প্ল্যানিং এন্ড ডেভেলপমেন্ট', time: 'সকাল ১০টা - দুপুর ১টা' }),
      makeDoctor({ name: 'ডাঃ আব্দুল্লাহ আল জাহেদ', quals: 'এমবিবিএস (এজাজ মেডিকেল কলেজ), বিসিএস (স্বাস্থ্য) \nএফসিপিএস-এফপি (মেডিসিন)', specialty: 'মেডিসিন, বাত-ব্যথা ও ডায়াবেটিস রোগ বিশেষজ্ঞ', workplace: 'চট্টগ্রাম মেডিকেল কলেজ হাসপাতাল', time: 'সন্ধ্যা ৬টা - রাত ৯টা' }),
    ],
  }),
  // ----- সার্জারী বিভাগ -----
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডাঃ মিশমা ইসলাম', quals: 'এম.এস (জেনারেল সার্জারী), ডি.এম.ইউ, এ.এম.আর.ডি.এস (কোর্স)', specialty: 'জেনারেল, ল্যাপারস্কোপিক, ব্রেস্ট এন্ড কোলোরেক্টাল সার্জন', workplace: 'সহকারী অধ্যাপক, সার্জারী বিভাগ\nচট্টগ্রাম মেডিকেল কলেজ হাসপাতাল', time: 'দুপুর ২টা - বিকাল ৪টা' }),
      makeDoctor({ name: 'ডাঃ মোঃ আকরামুল আলম সাইমন', quals: 'এমবিবিএস, এমএস (জেনারেল সার্জারী),\nএমআরসিএস (শেষ পর্ব), ডিএমইউ', specialty: 'জেনারেল, ল্যাপারস্কোপিক এন্ড কোলোরেক্টাল সার্জন', workplace: 'সহকারী অধ্যাপক (সার্জারী বিভাগ)\nচট্টগ্রাম ইন্টারন্যাশনাল মেডিকেল কলেজ', time: 'বিকাল ৪.০০টা - সন্ধ্যা ৬.০০টা' }),
      makeDoctor({ name: 'ডাঃ তাসফিয়া রহমান', quals: 'এমবিবিএস, এম এস (সার্জিক্যাল অনকোলোজি)-কোর্স \nপিজিটি - (জেনারেল সার্জারী, সি এম সি)', specialty: 'জেনারেল,কোলোরেক্টাল এন্ড ব্রেস্ট সার্জারীতে অভিজ্ঞ', workplace: 'বাংলাদেশ মেডিকেল বিশ্ববিদ্যালয়, ঢাকা।', time: 'বিকাল ৪টা - রাত ৮টা' }),
      makeDoctor({ name: 'ডা. মো. আসফাকুল আসিফ', quals: 'এমবিবিএস (চট্টগ্রাম মেডিকেল কলেজ) বিসিএস (স্বাস্থ্য) \nএমএস (জেনারেল সার্জারি), বিএমইউ,সিসিডি (বারডেম)', specialty: 'জেনারেল, ল্যাপারোস্কপিক, কলোরেক্টাল এন্ড ব্রেস্ট সার্জন', workplace: 'কনসালটেন্ট, সার্জারি রেজিস্ট্রার \nচট্টগ্রাম মেডিকেল কলেজ এন্ড হাসপাতাল', time: 'দুপুর ২টা - বিকাল ৪টা' }),
    ],
  }),
  // ----- গাইনী বিভাগ -----
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডা: সুলতানা রওশন', quals: 'এমবিবিএস (ডিইউ), বিসিএস (স্বাস্থ্য) এমএস (বিএসএমএমইউ) \nডিএমইউ, এফসিজিপি ট্রেনিং ইন ইনফার্টিলিটি (আইসিআরসি)\nট্রেনিং ইন ল্যাপারোস্কপিক সার্জারী \nকনসালট্যান্ট-স্ত্রীরোগ, প্রসূতি \n', specialty: 'বন্ধ্যাত্ব্য বিশেষজ্ঞ ও ল্যাপারোস্কপিক সার্জন', workplace: 'সহকারী অধ্যাপক, চট্টগ্রাম মেডিকেল কলেজ হাসপাতাল।', time: 'সন্ধ্যা ৭টা - রাত ৮:৩০টা' }),
      makeDoctor({ name: 'ডাঃ মারজান সিদ্দিকা রূপসা', quals: 'এমবিবিএস (চট্টগ্রাম মেডিকেল কলেজ), বিসিএস (স্বাস্থ্য),\nএফসিপিএস (গাইনী এন্ড অবস্)', specialty: 'প্রসূতি ও স্ত্রীরোগ বিশেষজ্ঞ ও সার্জন', workplace: 'চট্টগ্রাম মেডিকেল কলেজ হাসপাতাল।', time: 'দুপুর ৩টা - বিকাল ৫টা' }),
      makeDoctor({ name: 'ডাঃ নুরুন নাহার রুমা', quals: 'এমবিবিএস, বিসিএস (স্বাস্থ্য), এমএস (গাইনী এন্ড অবস্)', specialty: 'গাইনী, স্ত্রীরোগ এবং বন্ধ্যাত্ব বিশেষজ্ঞ', workplace: 'রেজিস্ট্রার (গাইনী ও অবস্ বিভাগ) \nচট্টগ্রাম মেডিকেল কলেজ হাসপাতাল।', time: 'সন্ধ্যা ৬টা - রাত ৮টা' }),
      makeDoctor({ name: 'ডাঃ সাবরীনা আবেদীন', quals: 'এমবিবিএস (চট্টগ্রাম মেডিকেল কলেজ) এমএস (গাইনী এন্ড অ্যস), বিএমইউ', specialty: 'প্রসূতি ও স্ত্রীরোগ বিশেষজ্ঞ সার্জন', workplace: '', time: 'বিকাল ৪টা- সন্ধ্যা ৬টা' }),
      makeDoctor({ name: 'ডাঃ রোজি আকতার', quals: 'এমবিবিএস, এফসিপিএস (শেষ পর্ব), এমসিপিএস (গাইনি এন্ড অবস্)', specialty: 'প্রসূতি ও স্ত্রীরোগ বিশেষজ্ঞ', workplace: 'চট্টগ্রাম মেডিকেল কলেজ হাসপাতাল', time: 'বিকাল ৫টা- রাত ৮টা' }),
      makeDoctor({ name: 'ডা: কুসুম আক্তার', quals: 'এমবিবিএস, সিসিডি (বারডেম), সিএমইউ, ডিএমইউ, এফএমডি', specialty: 'প্রসূতি ও স্ত্রীরোগ চিকিৎসক', workplace: 'এক্স মেডিকেল অফিসার, \nচট্টগ্রাম মেডিকেল কলেজ হাসপাতাল।', time: 'দুপুর ১২টা - দুপুর ৩টা' }),
      makeDoctor({ name: 'ডা: ফাতেমা-তুজ-জোহরা', quals: 'এমবিবিএস, এমএরসিওজি (ইউকে) পার্ট-২', specialty: 'প্রসূতি ও স্ত্রীরোগ চিকিৎসক', workplace: 'এক্স মেডিকেল অফিসার, চট্টগ্রাম মেট্রোপলিটন হাসপাতাল\nএক্স আবাসিক মেডিকেল অফিসার\nহাটহাজারী মা ও শিশু হাসপাতাল', time: 'দুপুর ১২টা - দুপুর ৩টা' }),
    ],
  }),
  ...
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডা: মাহমুদ উল্লাহ ফারুকী', quals: 'এমবিবিএস (ঢাকা মেডিকেল কলেজ) \nবিসিএস (স্বাস্থ্য) এম.এস (ইএনটি)', specialty: 'নাক-কান-গলা রোগ বিশেষজ্ঞ এবং \nহেড-নেক সার্জন কনসালটেন্ট', workplace: 'সহকারী অধ্যাপক, ইএনটি ও হেড নেক সার্জারী', time: 'রাত ০৯টা - রাত ১০টা' }),
      makeDoctor({ name: 'ডা: মোঃ ইকবাল হোসেন', quals: 'এমবিবিএস, পিজিটি(ইএনটি), ডিএলও (কোর্স)  \nচট্টগ্রাম মেডিকেল কলেজ হাসপাতাল।', specialty: 'নাক কান গলা ও হেড নেক রোগের অভিজ্ঞ চিকিৎসক', workplace: '', time: 'সন্ধ্যা ৬ টা রাত ৮ টা' }),
    ],
  }),
  // ----- চর্মরোগ বিভাগ -----
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডা: মো. ওমর ফারুখ (রাজু)', quals: 'এমবিবিএস, ডিডিভি (বিএমইউ)', specialty: 'চর্ম, এলার্জি, কুষ্ঠ, এইডস, যৌনরোগ বিশেষজ্ঞ ও ডার্মাটোসার্জন', workplace: 'চট্টগ্রাম মেডিকেল কলেজ হাসপাতাল।', time: 'সন্ধ্যা ৭টা -রাত ৯টা' }),
      makeDoctor({ name: 'ডাঃ আয়াতুল্লাহ মোহাম্মদ সালমান', quals: 'এমবিবিএস (দিনাজপুর মেডিকেল কলেজ), ডিভস (ডার্মাটোলজি)\nপিজিটি (যৌন ও চর্ম), সিসিডি (বারডেম), এমসিজিপি (কোর্স), সিএমইউ', specialty: 'চর্মরোগ বিশেষজ্ঞ', workplace: '', time: 'সকাল ১১টা - দুপুর ১টা' }),
      makeDoctor({ name: 'ডাঃ সাবরিনা ইসলাম ফারমী', quals: 'এম.বি.বি.এস, ডি.এম.ইউ (আল্ট্রা) সিসিডি (বারডেম), পিজিটি (চর্ম ও যৌন)', specialty: 'এলার্জি, চর্ম, যৌন, ডায়াবেটিস ও আল্ট্রাসনোগ্রাফীতে অভিজ্ঞ', workplace: 'চট্টগ্রাম মেডিকেল কলেজ ও হাসপাতাল', time: 'সন্ধ্যা ৬টা - রাত ৮টা' }),
    ],
  }),
  // ----- ডেন্টাল বিভাগ -----
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডাঃ নুসরাত পারভীন রূপা', quals: 'বি.ডি.এস (ঢাকা ডেন্টাল কলেজ), \nপিজিটি (কনজারভেটিভ ডেন্টিস্ট্রি)', specialty: 'ওরাল এন্ড ডেন্টাল সার্জন', workplace: 'চট্টগ্রাম মেডিকেল কলেজ হাসপাতাল', time: 'বিকাল ৫.০০টা - রাত ৮.০০টা' }),
      makeDoctor({ name: 'ডাঃ ইশতিয়াক মো: আশফাক', quals: 'বিডিএস (ডিইউ) পিজিটি (ওএমএস)\nএক্স-অনারারী মেডিকেল অফিসার, \nওরাল এন্ড ম্যাক্সিলোফেসিয়াল সার্জারী (বিএসএমএমইউ) \nকনসালটেন্ট, ওরাল এন্ড ডেন্টাল ইউনিট \nচট্টগ্রাম সিটি কর্পোরেশন মোস্তফা হাকিম মাতৃসদন হাসপাতাল।', specialty: 'ওরাল এন্ড ডেন্টাল সার্জন', workplace: 'চট্টগ্রাম মেডিকেল কলেজ', time: 'সকাল ১০টা - দুপুর ২টা' }),
    ],
  }),
  // ----- হৃদরোগ বিভাগ -----
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডা: মোহাম্মদ শহীদুল্লাহ', quals: 'এমবিবিএস, বিসিএস (স্বাস্থ্য), ডি কার্ড, এমডি (কার্ডিওলজী)', specialty: 'হৃদরোগ, প্রেশার ও মেডিসিন বিশেষজ্ঞ', workplace: 'মেম্বার অব আমেরিকান কলেজ অব কার্ডিওলজি প্রিভেনটিব, ক্লিনিক্যাল এন্ড ইন্টারভেনশনাল কার্ডিওলজিস্ট', time: 'সন্ধ্যা ৬টা রাত ৯টা' }),
      makeDoctor({ name: 'ডা: তাজকিয়া তামকিন', quals: 'এমবিবিএস (সিএমসি), ডি-কার্ড (বিএমইউ) \n এফসিপিএস কার্ডিওলজি (কোর্স) \nট্রেইন্ড ইন ইকোকার্ডিওগ্রাফি (বাফ)', specialty: 'হৃদরোগ, উচ্চ রক্তচাপ ও বাতজ্বর বিশেষজ্ঞ ও মেডিসিনে অভিজ্ঞ', workplace: 'কনসালটেন্ট (কার্ডিওলজি) \nসম্মিলিত সামরিক হাসপাতাল (সিএমএইচ), চট্টগ্রাম।', time: 'বিকাল ৫টা - রাত ৭টা' }),
      makeDoctor({ name: 'ডাঃ সুজন কুমার ধর', quals: 'এম.বি.বি.এস, ডি-কার্ড সিসিডি (ডায়াবেটিস) পি.জি.টি. (মেডিসিন)', specialty: 'হৃদরোগ, বাত জ্বর, উচ্চ রক্তচাপ, মেডিসিন বিশেষজ্ঞ ও ডায়াবেটোলজিস্ট', workplace: 'কনসালটেন্ট কার্ডিওলজিস্ট', time: 'সকাল ১১টা - দুপুর ১টা' }),
    ],
  }),
  // ----- শিশু বিভাগ -----
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডা: সুনন্দা শীল', quals: 'এমবিবিএস, বিসিএস (স্বাস্থ্য), ডিসিএইচ', specialty: 'নবজাতক, শিশু ও কিশোর রোগ বিশেষজ্ঞ ', workplace: 'সহযোগী অধ্যাপক (শিশুস্বাস্থ্য বিভাগ) \nচট্টগ্রাম মেডিকেল কলেজ হাসপাতাল', time: 'সন্ধ্যা ৬টা - রাত ৮টা' }),
      makeDoctor({ name: 'ডা: নুসাইবা দ্বীন মুহাম্মদ', quals: 'এমবিবিএস (চট্টগ্রাম মা ও শিশু হাসপাতাল মেডিকেল কলেজ) \nএমডি (শিশু স্বাস্থ্য),', specialty: 'নবজাতক, শিশু ও কিশোর রোগ বিশেষজ্ঞ ', workplace: '', time: 'বিকাল ৩টা - বিকাল ৫টা' }),
      makeDoctor({ name: 'ডা: তাজরিনা রহমান জেনি', quals: 'এমবিবিএস, ডিসিএইচ (বিএসএমএমইউ) \nএফসিপিএস (শেষ পর্ব), সিসিডি (বারডেম)', specialty: 'নবজাতক, শিশু ও কিশোর রোগ বিশেষজ্ঞ ', workplace: 'রেজিস্ট্রার (শিশু স্বাস্থ্য বিভাগ), \nচট্টগ্রাম ইন্টারন্যাশনাল মেডিকেল কলেজ হাসপাতাল।', time: 'বিকাল ৫টা - রাত ৮টা' }),
      makeDoctor({ name: 'ডাঃ সুলতানা ইয়াসমিন', quals: 'এমবিবিএস (সিএমসি), বিসিএস (স্বাস্থ্য), ডিসিএইচ (বিএমইউ)\nএফসিপিএস, ফাইনাল পার্ট (পেডিয়াট্রিক নেফ্রোলজি)', specialty: 'নবজাতক, শিশু ও কিশোর রোগ বিশেষজ্ঞ', workplace: '', time: 'সন্ধ্যা ৭টা - রাত ৮টা' }),
    ],
  }),
  // ----- অর্থোপেডিক বিভাগ -----
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডাঃ মোঃ দিদারুল আলম', quals: 'এমবিবিএস, বিসিএস (স্বাস্থ্য) \nডি-অর্থো (বিএমইউ), এও ট্রমা (বেসিক) \nঅর্থোপেডিক ও ট্রমা সার্জন', specialty: 'হাঁড়-জোড়া, বাত-ব্যথা, জয়েন্ট ও মেরুদণ্ড রোগ বিশেষজ্ঞ', workplace: 'চট্টগ্রাম মেডিকেল কলেজ ও হাসপাতাল।', time: 'সন্ধ্যা ৬ টা- রাত ৮ টা' }),
      makeDoctor({ name: 'ডাঃ আবু জোনায়েদ রিফাত', quals: 'এমবিবিএস, পিজিটি (অর্থোপেডিক সার্জারি), পিজিটি (সার্জারি)', specialty: 'হাঁড়-জোড়া, বাত-ব্যথা, জয়েন্ট ও \nমেরুদণ্ড রোগ চিকিৎসক', workplace: 'এক্স মেডিকেল অফিসার  \nচট্টগ্রাম ইন্টারন্যাশনাল মেডিকেল কলেজ হাসপাতাল', time: 'বিকাল ৫.০০টা - রাত ৮.০০টা' }),
    ],
  }),
  ...
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'তানজিলা তাসমিন', quals: 'এম.এস.সি (এপ্লায়েড হিউম্যান নিউট্রিশন এন্ড ডায়েটেটিক্স) (সিভাসু)\nবিএসসি (ফুড সায়েন্স এন্ড টেকনোলজি) (সিভাসু)\nপিজিটি (ক্লিনিক্যাল নিউট্রিশন এন্ড ডায়েটেটিক্স, চাইল্ড নিউট্রিশন, ক্রিটিক্যাল কেয়ার এন্ড নিউট্রিশন) (বিএডিএন)', specialty: 'নিউট্রিশনিস্ট এন্ড ডায়েট কনসালটেন্ট', workplace: '', time: 'সন্ধ্যা ৭.৩০টা - রাত ৯.৩০টা' }),
    ],
  }),
  // ----- জেনারেল ফিজিশিয়ান -----
  makeDepartment({
    ...
    doctors: [
      makeDoctor({ name: 'ডা: সাইফুল ইসলাম', quals: 'এমবিবিএস (সিইউ), জেনারেল ফিজিশিয়ান', specialty: 'বাত ব্যথা ও চর্মরোগ চিকিৎসক', workplace: '', time: 'সকাল ১০টা - দুপুর ২টা' }),
      makeDoctor({ name: 'ডা: তোফায়েল আহমদ', quals: 'এমবিবিএস (সিএমসি), বিসিএস (স্বাস্থ্য) জেনারেল ফিজিশিয়ান', specialty: 'এডভ্যান্স ট্রেনিং টিভিএস, কালার ডপলার উন্নত প্রশিক্ষণ', workplace: '', time: 'সন্ধ্যা ৭টা - রাত ৯টা' }),
      makeDoctor({ name: 'ডা: চৌধুরী আরজিনা ইয়ামিন', quals: 'এমবিবিএস (সিএমসি), এমপিএইচ, ডিএমইউ (আল্ট্রাসনোগ্রাফি) \nসিসিডি (ডায়াবেটিস-বারডেম), ইসিডিভি (স্কিন ও ভিডি)', specialty: 'নবজাতক ও শিশু রোগে অভিজ্ঞ', workplace: '', time: 'সকাল ১১টা - দুপুর ১টা' }),
      makeDoctor({ name: 'ডাঃ আফরোজা সুলতানা নাসরিন', quals: 'এমবিবিএস, পিজিটি (গাইনি এন্ড অবস্) ডিএমইউ (আল্ট্রা) \nএডভ্যান্স ট্রেনিং অন টিভিএস, ফিটাল এনোমেলি স্ক্যান, \nথাইরয়েড এন্ড বেস্ট কনসালটেন্ট সনোলজিস্ট', specialty: 'প্রসূতি ও স্ত্রীরোগ চিকিৎসক', workplace: '', time: 'বিকাল ৫টা - সন্ধ্যা ৭টা' }),
    ],
  }),
];
...
export default function DoctorPanelBuilder() {
  // 🔥 ১ম সমাধান: শুরু থেকেই সিড ডেটা দিয়ে স্টেট লোড করা হয়েছে
  const defaultPanel = {
    id: 'শনিবার',
    name: 'শনিবার',
    title: 'শনিবারের ডক্টরস প্যানেল',
    activeDoctorIds: SEED_DEPARTMENTS.flatMap(d => d.doctors.map(doc => doc.id)),
  };

  const [departments, setDepartments] = useState(SEED_DEPARTMENTS);
  const [panels, setPanels] = useState([defaultPanel]);
  const [activePanelId, setActivePanelId] = useState(defaultPanel.id);
  const [footer, setFooter] = useState(SEED_FOOTER);
  const [loading, setLoading] = useState(false); // 🔥 লোডিং স্ক্রিন বন্ধ করা হয়েছে
  const [mode, setMode] = useState('edit');
  const [saveStatus, setSaveStatus] = useState('idle');
  const [checkedIds, setCheckedIds] = useState(new Set(defaultPanel.activeDoctorIds));
  ...
  // Load data from Firebase (Timeout সহ)
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        ...
        // 🔥 ২য় সমাধান: নেটওয়ার্ক হ্যাং বা টাইমআউট হলে কিছুই করা হবে না, সিড ডেটা থেকেই যাবে
        console.warn('Firebase blocked/hanging. Using seed data.');
        setLoading(false);
      }
    };
    loadData();
